            ...
            try {
                ...
                switch (instruccionId){
                    ...
                    case 6:
                        ...
                        Calles casilla40 = new Calles("El Muelle", this.getRefPantalla().getLblCasilla2(), "El Muelle", 400, 200, "Azul", 200, 200, 50, 200, 600 ,1400,1700,2000);
                        Calles casilla39 = new Calles("Impuestos 1", this.getRefPantalla().getLblCasilla3(), "Impuestos 1", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        Calles casilla38 = new Calles("Plaza Park", this.getRefPantalla().getLblCasilla4(), "Plaza Park", 350, 175, "Azul", 200, 200, 35, 175, 500 ,1100,1300,1500);
                        Calles casilla37 = new Calles("Fortuna 1", this.getRefPantalla().getLblCasilla5(), "Fortuna 1", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        Ferrocarriles casilla36 = new Ferrocarriles("Ferrocarril Vía Rápida", this.getRefPantalla().getLblCasilla6(), "Ferrocarril Vía Rápida", 200, 100);
                        Calles casilla35 = new Calles("Avenida Pensilvania", this.getRefPantalla().getLblCasilla7(), "Avenida Pensilvania", 320, 160, "Verde", 200, 200, 28,150, 450 ,1000,1200,1400);
                        Calles casilla34 = new Calles("Arca Comunal 1", this.getRefPantalla().getLblCasilla8(), "Arca Comunal 1", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        Calles casilla33 = new Calles("Avenida Carolina del Norte", this.getRefPantalla().getLblCasilla9(), "Avenida Carolina del Norte", 300, 150, "Verde", 200, 200, 26, 130, 390 ,900,1100,1275);
                        Calles casilla32 = new Calles("Avenida Pacífico", this.getRefPantalla().getLblCasilla10(), "Avenida Pacífico", 300, 150, "Verde", 200, 200, 26, 130, 390 ,900,1100,1275);
                        Calles casilla31 = new Calles("Vaya a la cárcel", this.getRefPantalla().getLblCasilla11(), "Vaya a la cárcel", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        
                        Calles casilla30 = new Calles("Jardines Marvin", this.getRefPantalla().getLblCasilla12(), "Jardines Marvin", 280, 140, "Amarillo", 150, 150, 24, 120, 360 ,850,1025,1200);
                        Servicios casilla29 = new Servicios("Servicios agua", this.getRefPantalla().getLblCasilla13(), "Servicios agua", 150, 75);
                        Calles casilla28 = new Calles("Avenida Ventnor", this.getRefPantalla().getLblCasilla14(), "Avenida Ventnor", 260, 130, "Amarillo", 150, 150, 22, 110, 330 ,800,975,1150);
                        Calles casilla27 = new Calles("Avenida Atlántico", this.getRefPantalla().getLblCasilla15(), "Avenida Atlántico", 260, 130, "Amarillo", 150, 150, 22, 110, 330 ,800,975,1150);
                        Ferrocarriles casilla26 = new Ferrocarriles("Ferrocarril B&O", this.getRefPantalla().getLblCasilla16(), "Ferrocarril B&O", 200, 100);
                        Calles casilla25 = new Calles("Avenida Illinois", this.getRefPantalla().getLblCasilla17(), "Avenida Illinóis", 240, 120, "Rojo", 150, 150, 20, 100, 300 ,750,925,1100);
                        Calles casilla24 = new Calles("Avenida Indiana", this.getRefPantalla().getLblCasilla18(), "Avenida Indiana", 220, 110, "Rojo", 150, 150, 18, 90, 250 ,700,875,1050);
                        Calles casilla23 = new Calles("Fortuna 2", this.getRefPantalla().getLblCasilla19(), "Fortuna 2", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        Calles casilla22 = new Calles("Avenida Kentucky", this.getRefPantalla().getLblCasilla20(), "Avenida Kentucky", 220, 110, "Rojo", 150, 150, 18, 90, 250 ,700,875,1050);
                        Calles casilla21 = new Calles("Parqueo Libre", this.getRefPantalla().getLblCasilla21(), "Parqueo Libre", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        
                        Calles casilla20 = new Calles("Avenida New York", this.getRefPantalla().getLblCasilla22(), "Avenida New York", 200, 100, "Naranja", 100, 100, 16, 80, 220 ,600,800,1000);
                        Calles casilla19 = new Calles("Avenida Tennessee", this.getRefPantalla().getLblCasilla23(), "Avenida Tennessee", 180, 90, "Naranja", 100, 100, 14, 70, 200 ,550,750,950);
                        Calles casilla18 = new Calles("Arca Comunal 2", this.getRefPantalla().getLblCasilla24(), "Arca Comunal 2", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        Calles casilla17 = new Calles("Plaza St James", this.getRefPantalla().getLblCasilla25(), "Plaza St James", 180, 90, "Naranja", 100, 100, 14, 70, 200 ,550,750,950);
                        Ferrocarriles casilla16 = new Ferrocarriles("Ferrocarril Pensilvania", this.getRefPantalla().getLblCasilla26(), "Ferrocarril Pensilvania", 200, 100);
                        Calles casilla15 = new Calles("Avenida Virginia", this.getRefPantalla().getLblCasilla27(), "Avenida Virginia", 160, 80, "Rosado", 100, 100, 12, 60, 180 ,500,700,900);
                        Calles casilla14 = new Calles("Avenida Status", this.getRefPantalla().getLblCasilla28(), "Avenida Status", 140, 70, "Rosado", 100, 100, 10, 50, 150 ,450,625,750);
                        Servicios casilla13 = new Servicios("Servicios electricidad", this.getRefPantalla().getLblCasilla29(), "Servicios electricidad", 150, 75);
                        Calles casilla12 = new Calles("Plaza San Carlos", this.getRefPantalla().getLblCasilla30(), "Plaza San Carlos", 140, 70, "Rosado", 100, 100, 10, 50, 150 ,450,625,750);
                        Calles casilla11 = new Calles("La cárcel", this.getRefPantalla().getLblCasilla31(), "La cárcel", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
                        
                        Calles casilla10 = new Calles("Avenida Connecticut", this.getRefPantalla().getLblCasilla32(), "Avenida Connecticut", 120, 60, "Celeste", 50, 50, 8, 40, 100 ,300,450,600);
                        Calles casilla9 = new Calles("Avenida Vermont", this.getRefPantalla().getLblCasilla33(), "Avenida Vermont", 100, 50, "Celeste", 50, 50, 6, 30, 90 ,270,400,550);
                        Calles casilla8 = new Calles("Fortuna 3", this.getRefPantalla().getLblCasilla34(), "Fortuna 3", 0, 0, "Ninguno", 0, 0, 0, 0, 0 ,0,0,0);
